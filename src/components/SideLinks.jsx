  ...
  const links = [
    {
      ...
      label: t.sideLinks.linkedinLabel,
      title: 'LinkedIn',
      icon: (
    ...
    },
    {
      ...
      label: t.sideLinks.certificateLabel,
      title: t.sideLinks.certificateTitle,
      icon: (
